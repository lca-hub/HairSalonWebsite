...
(id, name, description)
VALUES
(1, 'Cắt & Tạo kiểu', 'Các dịch vụ cắt tóc, gội đầu và tạo kiểu.'),
(2, 'Nhuộm tóc', 'Các dịch vụ nhuộm, phủ bạc, highlight, balayage và ombre.'),
(3, 'Chăm sóc tóc', 'Các dịch vụ hấp dầu, dưỡng tóc và chăm sóc da đầu.'),
(4, 'Phục hồi tóc', 'Các dịch vụ phục hồi tóc khô xơ, tóc tẩy và tóc hư tổn.'),
(5, 'Sản phẩm chăm sóc tóc', 'Dầu gội, dầu xả, mặt nạ tóc, dầu dưỡng và sản phẩm tạo kiểu.');

-- =========================================================
-- DỊCH VỤ: 22 dòng
-- image_url = NULL để bạn dán link ảnh sau
-- =========================================================
INSERT INTO service
...
(5, 'APT005', 1, 1, 3, '2026-09-06', '09:30:00', '10:30:00', 220000.00, 'PENDING', 0.00, 'Muốn layer nhẹ.', NULL, '2026-09-02 08:00:00', '2026-09-06 08:30:00'),
...
VALUES
(1, 1, 'TXN001', 750000.00, 'CASH', 'SUCCESS', '2026-08-29 15:35:30'),
(2, 2, 'TXN002', 120000.00, 'CASH', 'SUCCESS', '2026-09-07 15:35:30');
...
VALUES
(1, 'ORD001', 1, 1420000.00, 50000.00, 30000.00, 1400000.00, 'COD', 'PENDING', 'PENDING', 'Nguyễn An', '0900000002', 'Quận 6, TP. Hồ Chí Minh', 'Giao giờ hành chính.', '2026-09-01 11:00:00', '2026-09-01 11:00:00'),
(2, 'ORD002', 2, 1280000.00, 80000.00, 0.00, 1200000.00, 'COD', 'PAID', 'CONFIRMED', 'Trần Bình', '0900000003', 'Quận 3, TP. Hồ Chí Minh', 'Gọi trước khi giao.', '2026-09-02 10:00:00', '2026-09-02 10:20:00');
