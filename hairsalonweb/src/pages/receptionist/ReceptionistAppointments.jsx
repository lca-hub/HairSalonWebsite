...
function ReceptionistAppointments() {
    ...
    useEffect(() => {
        if (form) {
            getSlots(form.stylistId, form.appointmentDate, form.serviceId);
        }
    ...
    return (
        <div className="admin-page receptionist-appointments-page">
            <Header role="RECEPTIONIST" title="Lịch hẹn" />

            <main className="admin-main">
                <div className="admin-shell">

                    <section className="admin-heading receptionist-appointments-heading">
                        <div>
                            <span className="admin-eyebrow">APPOINTMENT MANAGEMENT</span>
                            <h1>Lịch hẹn</h1>
                            <p>Tạo, đổi lịch và xử lý lịch hẹn của khách hàng.</p>
                        </div>
                    ...
                    <section className="admin-filter-card receptionist-appointment-filters">
                    ...
                    <section className="admin-table-card">
                        ...
                        {loading ? (
                            ...
                            <div className="admin-empty">
                                <strong>Không có lịch hẹn</strong>
                            </div>
                        ) : (
                                        ...
                                        {items.map((appointment) => (
                                            <tr key={appointment.id}>
                                                ...
                                                <td data-label="Trạng thái">
                                                    <span className={`receptionist-appointment-status receptionist-appointment-status-${String(appointment.status || "").toLowerCase()}`}>
